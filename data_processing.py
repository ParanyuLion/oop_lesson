...
# - print the min temperature for all the cities in Italy
my_country = 'Italy'
print("The min temperature for all the cities in", my_country, ":")
print(aggregate('temperature', lambda x: min(x), filter(lambda x: (x['country']) == my_country, cities)))
print()
# - print the max temperature for all the cities in Sweden
temps = []
my_country = 'Sweden'
print("The min temperature for all the cities in", my_country, ":")
print(aggregate('temperature', lambda x: max(x), filter(lambda x: (x['country']) == my_country, cities)))
print()
